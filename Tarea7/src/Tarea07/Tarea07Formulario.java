...
public class Tarea07Formulario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Tarea07Formulario
     */
    public Tarea07Formulario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tarea07Formulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tarea07Formulario().setVisible(true);
            }
        });
    }
